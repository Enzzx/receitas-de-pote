...
export default function MainNavbar() {
    return (
        <ul>
            ...
            <li><NavLink to="/list" className={({ isActive }) => (isActive ? "active-page" : "") } end><img src="./icons/to-do.png" alt="to-do list" /> <span>Lista</span></NavLink></li>
            ...
            <li><NavLink to="/about" className={({ isActive }) => (isActive ? "active-page" : "") } end><img src="./icons/info.png" alt="info" /> <span>Sobre</span></NavLink></li>
        </ul>
    )
}